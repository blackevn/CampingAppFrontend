import { Form, Button, Input, TextArea, GroupedInput } from "../components"
import { faArrowAltCircleRight, faEnvelope } from "@fortawesome/free-solid-svg-icons"
...
const Contact = () => {
    ...
    return (
        ...
        <h1 className="text-4xl py-4">Contact</h1>
          ...
          <section className=" text-gray-600 dark:text-gray-200 grid place-items-center">

            <div className="block rounded-lg bg-white dark:bg-base-100 ">
            <div className="flex flex-wrap items-center">
                ...
                <div className="flex flex-wrap pt-12 lg:pt-0">
                    <div className=" grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
                    <div className="flex items-start">
                        <div className="shrink-0">
                        <div className="p-4 bg-primary rounded-lg shadow-md w-14 h-14 flex items-center justify-center">
            ...
            <div
                class="block rounded-lg py-10 md:py-12 px-4 md:px-6"
