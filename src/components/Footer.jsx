import { faArrowAltCircleRight, faCopyright, faEnvelope } from "@fortawesome/free-solid-svg-icons";
...
const Footer = () => {
  ...
  return (<>
            ...
            <footer className="footer p-10 bg-white dark:bg-base-100 text-gray-600 dark:text-gray-200">
            <div>
                
                          
                <span className="footer-title">Services</span> 
                <Link to="pitchtypes" className="link link-hover">Pitch types and Availability</Link> 
                <Link to="/attractions" className="link link-hover">Attractions</Link> 
                <Link to="/store" className="link link-hover">Store</Link> 
                <Link to="/posts" className="link link-hover">Experiences</Link>
            </div> 
            <div>
            ...
            {location.pathname !== "/contact" &&  <div className={` md:flex hidden`}>
            <GroupedInput
                modifier="input"
                icon={faEnvelope}
            ...
            >
                <Button
                    modifier="btn bg-primary text-white"
            ...
            <footer className="footer px-10 py-4 bg-white dark:bg-base-100 text-gray-600 dark:text-gray-200 ">
            <div className="items-center grid-flow-col">
                ...
                <p className="font-black">GWSC  <FontAwesomeIcon icon={faCopyright}/>  {date}</p>
            </div> 
            <span className="badge my-2">
            {location.pathname === "/" ? <p>You are on the <span className="font-bold">HOME</span> page</p> : <p>You are on the {`${location.pathname.substring(1).toUpperCase()}`} page</p>}
            </span>
